...
1. Within the Remote Desktop session to the **az104-10-vm1** Azure virtual machine, start an Edge web browser, browse to the Azure portal at ```https://portal.azure.com```, and sign in using your credentials.
